        ...
        <div>
             <div>
                ...
                <div className="modal-box">
                    ...
                    <h2 className="text-xl font-semibold mt-5 capitalize text-center">{`Do you really want to Delete ${userName} as a Teacher!!`}</h2>
                    <p className='text-right'><button onClick={handleRole} className={`btn btn-outline btn-error} mt-5`}>Delete Teacher</button></p>
